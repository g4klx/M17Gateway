...
OBJECTS = Conf.o Echo.o Log.o M17LSF.o M17Network.o Mutex.o M17Gateway.o M17Utils.o Reflectors.o RptNetwork.o StopWatch.o Thread.o Timer.o \
		  UDPSocket.o Utils.o Voice.o
